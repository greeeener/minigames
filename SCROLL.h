...
void mapping();              //맵 출력
void Jump();                 //점프
void Gravity();              //점프 하거나 말거나, 주기적으로 플레이어를 밑으로 내려가게 하는 함수(이름은 재밌게 중력으로 함 ㅎ)
void Obstacle();             //장애물
void MapMove();              //맵을 왼쪽으로 한 칸씩 밈
int Gameover();             //게임 오버 화면
void gotoxy(int x, int y);    //화면을 안 깜빡거리게 할려고 콘솔창 맨 위로 가 덮어서 출력하게 하기 위해 씀
void CursorView(bool show);  //커서를 안 보이게 하기 위해 씀
//메인 함수***************************************************************************
